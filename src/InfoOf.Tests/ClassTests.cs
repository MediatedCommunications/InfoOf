...
namespace Tests {
    public class ClassTests {
        ...
        [Test]
        public void Test1() {
            var Instance1 = new Class_Derived() {
            ...
            var P1 = InfoOf.Type<Class_Derived>().Property(x => x.Source_Name);
            var P2 = InfoOf.Type<Class_Derived>().Property(x => x.Dest_Name);
        ...
        public void Test2() {
            ...
            var P1 = InfoOf.Type(typeof(Class_Derived)).Property(nameof(Class_Basic.Source_Name));
            var P2 = InfoOf.Type(typeof(Class_Derived)).Property(nameof(Class_Basic.Dest_Name));
        ...
        public void Test3() {
            ...
            var P1 = InfoOf.Type<Class_Derived>().Property(x => x.Source_Date);
            var P2 = InfoOf.Type<Class_Derived>().Property(x => x.Dest_Date);
        ...
        public void Test4() {
            ...
            var P1 = InfoOf.Type(typeof(Class_Derived)).Property(nameof(Class_Basic.Source_Date));
            var P2 = InfoOf.Type(typeof(Class_Derived)).Property(nameof(Class_Basic.Dest_Date));
